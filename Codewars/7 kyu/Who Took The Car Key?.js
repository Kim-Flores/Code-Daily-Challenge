...
*"If you're reading this then I have left the state and am well on my way to freedom. Just to make things interesting, I have also provided something for you to track me with. 
Let the chase begin..."*
...
function whoTookTheCarKey(message) {
  let newmsg = ''
  message.map(item => newmsg += String.fromCharCode(parseInt(item,2).toString(10)))
  return newmsg
}
